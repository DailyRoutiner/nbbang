      			...
      			<div class="col-lg-6 col-md-6 col-sm-12">
                      ...
                      <!-- PICTURE UPLOAD -->
               		<form action="picEnroll.do" method="post" class="form-signin"  enctype="multipart/form-data">
                		...
                		<img src="${requestScope.mempic}" style="width:128px;height:128px">  ${requestScope.mempic}
                <!-- PICTURE UPLOAD -->
						 ...
						 <form class="form-horizontal style-form" method="post" action = "updateName.do">
							<input type = "hidden" value="updateName.do" name= "command">
                             <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="password" class="form-control" name="memname">
                              </div>
                          </div>
                          <br><br>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                         			<%-- <input type="hidden" class="form-control" name="email" value = "${sessionScope.getEmail()}"> --%>
                              </div>
                          	</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-12">
                      ...
                      <form class="form-horizontal style-form" method="post">
                          ...
                          <div class="form-group">
                              ...
                              <a class="col-sm-6" data-toggle="modal" data-target="#password">카드번호 변경</a>
                          </div>
                          <div class="form-group">
                  					...
                  					<div class="form-panel">
                     					 <form class="form-horizontal style-form" method="get">
        									...
        									<div class="col-sm-10">
                              				...
                              				<br>
                              				<div class="col-sm-10">
                              					<input type="text" class="form-control" name="mempw"  value="비밀번호 확인">
                              				</div>
                              				<br>
          									<div class="col-sm-10">
          										<button type="submit" class="btn btn-info" name="command" value="addSpend">확인</button>
          									</div>
						      		</div>
